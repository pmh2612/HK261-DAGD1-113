...
| `decisions-vi.md` | The same six decisions written in Vietnamese as a standalone hand-over for the other member: plain-language context, the options, a recommendation and a reply box for each. Discussion copy — `decisions.md` stays the record of what was chosen. | 1.3 |
...
All of September's documents are drafted: `requirements.md`, `decisions.md`,
`decisions-vi.md` and `learning-path.md` (2026-09-23), `architecture.md` (2026-09-24).
`kg-schema.md` follows in October (Roadmap 2.1).
